...
void LCD_VINT(u8 port_name)
{
	...
	_delay_ms(1);
	LCD_VSEND_CMD(port_name,CURSOR_OFF_DISPLAY_ON);
	_delay_ms(5);
	...
	_delay_ms(200);
	DIO_set_vPinDir(port_name,PA4,output);
	DIO_set_vPinDir(port_name,PA5,output);
	DIO_set_vPinDir(port_name,PA6,output);
	DIO_set_vPinDir(port_name,PA7,output);
	DIO_set_vPinDir('B',RW,output);
	DIO_set_vPinDir('B',RS,output);
	DIO_set_vPinDir('B',EN,output);
	DIO_SET_VPinVal('B',RW,low);
